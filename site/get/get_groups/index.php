...
if($faculty_id){ // Проверка, что ID передан
	$query="SELECT groups.group_id, group_name FROM groups INNER JOIN schedule ON groups.group_id=schedule.group_id WHERE faculty_id=$faculty_id ORDER BY group_name ASC"; //SQL запрос
